  ...
  return (
    <div class="isolate bg-white px-6 py-24 sm:py-24 lg:px-8">
      <div
        ...
        aria-hidden="true"
      >
        <div class="relative top-[200vh] left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"></div>
      </div>
